...
def objective (trial): 
    ...
    fc_pair = trial.suggest_categorical(
    "fc_pair",
    [
        "256_128",
        "256_256",
    ...
    fc_size, fc_size2 = map(int, fc_pair.split("_"))
...
if __name__ == "__main__":
    ...
    study = optuna.create_study(
        ...
        storage="sqlite:///" + str(DATA_DIR / "architecture_search3.db"),
        direction="minimize",
        load_if_exists=True,
    ...
    results_df.to_csv(DATA_DIR / "architecture_search_results2.csv", index=False)    
